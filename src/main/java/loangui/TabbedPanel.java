...
public class TabbedPanel extends JPanel implements ChangeListener, DiffListener {
    ...
    public void itemChanged(Double lMensHorsAss,
        ...
        Double lPctSalary = salary.equals(0F) ? 0F : lMens / salary * 100D;
